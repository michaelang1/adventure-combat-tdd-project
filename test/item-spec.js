...
// Below is added for the TDD project
describe('Flashlight', () => {
	let flashlight = new Flashlight('flashy', 'a bright flashlight');

	it('should have name and description attributes', () => {
		expect(flashlight.name).to.equal('flashy');
		expect(flashlight.description).to.equal('a bright flashlight');
	});

	it('should be an instance of Item and Flashlight', () => {
		expect(flashlight instanceof Flashlight).to.be.true;
		expect(flashlight instanceof Item).to.be.true;
	});
});
